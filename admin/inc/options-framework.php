<?php
	...
	*/
	...
	/**
	* Set up actions so we initialise ourselves
	*
	* @author Devin Thomas
	* @package OptionsFramework
	* @since 1.0
	*/
	...
	function optionsframework_rolescheck()
	{
		...
		if( current_user_can( 'edit_theme_options' ) )
		{
			...
			do_action( 'of_initialised' );
		
		}

	}/* optionsframework_rolescheck() */
	...
	*/
	...
	}/* optionsframework_load_sanitization() */
	...
	}/* optionsframework_page_capability() */
	...
	*/
	...
	if( !function_exists( 'optionsframework_add_page' ) )
	{
		...
		function optionsframework_add_page()
		{
			...
			$of_page = add_theme_page( __( 'Theme Options', THEMENAME ), __( 'Theme Options', THEMENAME ), 'edit_theme_options', 'options-framework','optionsframework_page' );
			
			// Load the required CSS and javscript
			add_action( 'admin_enqueue_scripts', 'optionsframework_load_scripts' );
			add_action( 'admin_print_styles-' . $of_page, 'optionsframework_load_styles' );

		}/* optionsframework_add_page() */
	...
	if( !function_exists( 'optionsframework_page' ) ) :
		...
		function optionsframework_page()
		{
			...
			<div id="optionsframework-wrap" class="wrap">
		    	...
		    	<h2 class="nav-tab-wrapper"><?php echo optionsframework_tabs(); ?></h2>
				    ...
				    <div id="optionsframework" class="postbox">
						...
						<form action="options.php" method="post">
							...
							<div id="optionsframework-submit">
								...
								<input type="submit" class="reset-button button-secondary" name="reset" value="<?php esc_attr_e( 'Restore Defaults', 'optionsframework' ); ?>" onclick="return confirm( '<?php print esc_js( __( 'Click OK to reset. Any theme settings will be lost!', THEMENAME  ) ); ?>' );" />
	...
	if( !function_exists( 'optionsframework_validate' ) ) :
		...
		function optionsframework_validate( $input )
		{
			...
			if( isset( $_POST['reset'] ) )
			{
				...
				add_settings_error( 'options-framework', 'restore_defaults', __( 'Default options restored.', THEMENAME  ), 'updated fade' );
			...
			else
			{
				...
				//Allow us to hook into here to adjust the save routine if necessary
				do_action( 'of_save_options_before', $options );
				...
				add_settings_error( 'options-framework', 'save_options', __( 'Options saved.', THEMENAME  ), 'updated fade' );
