<?php
	...
	}/* of_sanitize_background_position() */
	...
	}/* of_sanitize_background_attachment() */
	...
	function of_recognized_background_repeat()
	{
		...
		$default = array(
			'no-repeat' => __('No Repeat', THEMENAME ),
			'repeat-x'  => __('Repeat Horizontally', THEMENAME ),
			'repeat-y'  => __('Repeat Vertically', THEMENAME ),
			'repeat'    => __('Repeat All', THEMENAME ),
		);

		return apply_filters( 'of_recognized_background_repeat', $default );

	}/* of_recognized_background_repeat() */
	...
	function of_recognized_background_position()
	{
		...
		$default = array(
			'top left'      => __('Top Left', THEMENAME ),
			'top center'    => __('Top Center', THEMENAME ),
			'top right'     => __('Top Right', THEMENAME ),
			'center left'   => __('Middle Left', THEMENAME ),
			'center center' => __('Middle Center', THEMENAME ),
			'center right'  => __('Middle Right', THEMENAME ),
			'bottom left'   => __('Bottom Left', THEMENAME ),
			'bottom center' => __('Bottom Center', THEMENAME ),
			'bottom right'  => __('Bottom Right', THEMENAME )
		);
	...
	function of_recognized_background_attachment()
	{
		...
		$default = array(
			'scroll' => __('Scroll Normally', THEMENAME ),
			'fixed'  => __('Fixed in Place', THEMENAME )
		);
	...
	function of_recognized_font_styles()
	{
		...
		$default = array(
			...
			'italic'      => __('Italic', THEMENAME ),
			'bold'        => __('Bold', THEMENAME ),
			'bold italic' => __('Bold Italic', THEMENAME )
		);
