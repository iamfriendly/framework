<?php
	...
	class OF_Field_text extends OF_Field
	{
		...
		public function html()
		{
			...
			$this->output .= '<input placeholder="' . esc_attr( $this->value['std'] ) . '" id="' . esc_attr( $this->value['id'] ) . '" class="of-input" name="' . esc_attr( $this->option_name . '[' . $this->value['id'] . ']' ) . '" type="text" value="' . esc_attr( $this->val ) . '" />';
	...
	class OF_Field_upload extends OF_Field
	{
		...
		public function html()
		{
			...
			$this->output .= optionsframework_medialibrary_uploader( $this->value['id'], $this->val, null );
	...
	/**
	 * Questions and Answers - clicking on heading expands the answer
	 *
	 * @author Richard Tape
	 * @package 
	 * @since 1.0
	...
	class OF_Field_qna extends OF_Field
	{
		...
		public function enqueue_scripts()
		{
			...
			wp_enqueue_script( 'qnascript', OPTIONS_FRAMEWORK_DIRECTORY . 'js/qna.js', 'jquery' );
		...
		public function enqueue_styles()
		{
			...
			wp_enqueue_style( 'qnastyles', OPTIONS_FRAMEWORK_DIRECTORY . 'css/qna.css' );
