...
function phpconsole_settings() {
    ...
    */
    ...
    //$domain = '.local.letmeknow'; // don't forget to use leading dot, like so: .your-domain.com
    $domain = '';
    ...
    $users[] = array(
        'Rich',
        'PUUpdnCjsI45CoI3y1KFr5W0mFZrjd7HCY22h8tvPqWOg3PUVyWlw3AIDSK31tvo',
        'Kj3DgEBVFcf9yn5OF3v3XfEuyIb8wls9rYhtn5nfKgBQgTOZOeXgymI2RCflroWw'
    );
...
function phpconsole_curl($url, $params) {
     ...
     */
    //echo 'Code: '.$http_code.'<br>';
    //echo 'Description: '.$curl_error;
}
